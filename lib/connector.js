...
const SQLConnector = require('./sql');
const g = SG();
...
/**
 * Return the database mapping name of the property of the model if it exists.
 * Otherwise return the property name.
 * @param {String} model The target model name
 * @param {String} prop The property name
 */
Connector.prototype.propMapping = function(model, prop) {
  return SQLConnector.SQLConnector(model, prop);
};

/**
 * Return the database mapping name of the id property of the model if it exists.
 * Otherwise return the name of the id property.
 * @param {String} model The target model name
 * @param {String} prop The property name
 */
Connector.prototype.idMapping = function(model) {
  return SQLConnector.idColumn(model);
};
